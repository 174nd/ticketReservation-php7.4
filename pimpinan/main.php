...
<body class="hold-transition layout-top-nav text-sm">
  <div class="wrapper">
    <?php include $backurl . 'pimpinan/config/header.php'; ?>

    <!-- Content Wrapper. Contains page content -->
    <div class="content-wrapper">
      <?php include $backurl . 'pimpinan/config/content-header.php'; ?>
          ...
          <div class="row">
            ...
            <section class="col-lg-4 connectedSortable">
              <div class="card card-primary card-outline collapsed-card">
                ...
                <div class="card-body">
                  <div class="table-responsive">
                    <table id="table_jadwal" class="table table-bordered table-hover w-100" style="min-width: 200px;">
                      <thead>
                        <tr>
                          <th>Jadwal</th>
                          <th>Nama Kapal</th>
              ...
              <div class="card card-primary card-outline" id="cari_penumpang">
                <div class="card-header">
              ...
              <form action="<?= $df['home'] . 'export/laporan-penumpang.php' ?>" class="card card-primary card-outline" method="POST" enctype="multipart/form-data" autocomplete="off">
                <div class="card-header">
                  <h3 class="card-title">Laporan Data Penumpang</h3>
                  <div class="card-tools">
                    <button type="button" class="btn btn-tool" data-card-widget="collapse">
                      <i class="fas fa-minus"></i>
                    </button>
                ...
                <div class="card-body">
                  <ul class="list-group list-group-unbordered">
                    <li class="list-group-item">
                      <div class="input-group">
                        <input type="text" name="tgl_keberangkatan" id="tgl_keberangkatan" class="form-control mydatetoppicker" placeholder="Tanggal Pemesanan">
                        <div class="input-group-append">
                          <span class="input-group-text"><i class="fa fa-calendar"></i></span>
                        </div>
                      </div>
                    ...
                    <li class="list-group-item">
                      <button type="submit" name="cari-penumpang" class="btn btn-block btn-outline-primary">Cari</button>
                    </li>
                  </ul>
                </div>
              </form>
    ...
    <!-- /.modal -->
    <?php include $backurl . 'pimpinan/config/modal.php'; ?>
