  ...
  <div class="login-box">
    ...
    <div class="card">
      <div class="card-body login-card-body">
        <p class="login-box-msg">silahkan registrasi terlebih dahulu jika anda belum memiliki akun</p>
        <form action="" method="POST" autocomplete="off">
          ...
          <div class="row">
            ...
            <div class="col-md-6 order-md-1 mt-md-0 my-3">
              <a href="<?= $df['host'] . 'register/'; ?>" class="btn btn-warning btn-block">Registrasi</a>
            </div>
            <!-- /.col -->
            <div class="col-12 order-md-3 text-center">
              <a href="<?= $df['host'] . 'panduan.pdf'; ?>">Panduan Registrasi</a>
            </div>
          </div>
        </form>
      </div>
