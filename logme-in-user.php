  ...
  <div class="login-box">
    ...
    <div class="card">
      <div class="card-body login-card-body">
        <p class="login-box-msg">bagi penumpang yang belum miliki akun silahkan registrasi terlebih dahulu</p>
        <form action="" method="POST" autocomplete="off">
          ...
          <div class="row">
            ...
            <div class="col-md-6 order-md-1 mt-md-0 mt-3 d-flex align-items-center">
              <a href="<?= $df['host'] . 'register/'; ?>">Registrasi</a>
            </div>
            <!-- /.col -->
          </div>
        </form>
